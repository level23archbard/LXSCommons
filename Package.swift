...
let package = Package(
    ...
    products: [
        ...
        .library(name: "LXSCommons", targets: ["LXSCommons"]),
        .library(name: "LXSPluginMP", targets: ["LXSCommons", "LXSPluginMP"]),
        .library(name: "LXSPluginSCN", targets: ["LXSCommons", "LXSPluginSCN"]),
    ],
    dependencies: [
