...
final class LXSCommonsTests: XCTestCase {
    ...
    ("testManyRandomBinary", testManyRandomBinary),
    ("testVectorStruct", testVectorStruct),
    ("testMatrixStruct", testMatrixStruct),
    ("testPerformanceMatrixMultiply", testPerformanceMatrixMultiply),
    ("testPerformanceMatrixSlowMultiply", testPerformanceMatrixSlowMultiply),
    ]
